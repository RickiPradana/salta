        ...
        <div class="container pb-5 overflow-hidden">
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                    <div class="accordion accordion-flush bg-light rounded p-5" id="accordionFlushSectionnav">
                        <div class="accordion-item rounded-top">
                            <h2 class="accordion-header" id="flushnav-headingOne">
                            ...
                            <div id="flushnav-collapseOne" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flushnav-headingTwo">
                            ...
                            <div id="flushnav-collapseTwo" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flushnav-headingThree">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div id="flushnav-collapseThree" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flushnav-headingFour">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div id="flushnav-collapseFour" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flushnav-headingFive">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div id="flushnav-collapseFive" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-item rounded-bottom">
                            <h2 class="accordion-header" id="flushnav-headingSix">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div id="flushnav-collapseSix" class="accordion-collapse collapse"
