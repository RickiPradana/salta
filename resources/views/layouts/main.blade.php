...
<body>
                    ...
                    <div class="container">
                        <div class="row gy-0 gx-5">
                            <div class="col-lg-0 col-xl-5">
                                {{-- <img src="{{ asset('') }}assets/img/contentslide2.jpeg" alt="Logo"> --}}
                            </div>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-DKHDMBW5PJ"></script>
    <script>
